...
$stmt = $pdo->prepare("INSERT INTO books (seller_id, category_id, title, author, description, condition_type, condition_notes, price, original_price, location, district, image_url)
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->execute([$_SESSION['user_id'], $category_id, $title, $author, $description, $condition_type, $condition_notes, $price, $original_price, $location, $district, $image_url]);
